// Interop peer built on quic-go/webtransport-go v0.9 (draft-02 era: the
// compatibility surface browsers and quiche-backed stacks speak; v0.13+
// requires RESET_STREAM_AT, which quiche does not implement yet).
//
